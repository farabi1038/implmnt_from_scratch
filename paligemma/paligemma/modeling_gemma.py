# paligemma/modeling_gemma.py
# This file implements the Gemma language model components.
...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    """Repeats key and value states to match the number of query heads."""
...
class GemmaAttention(nn.Module):
    """Multi-head attention module for Gemma model."""
