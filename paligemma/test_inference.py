# test_inference.py
# This script runs inference with a PaLiGemma model.
...
def get_model_inputs(
    ...
    """Process an image and prompt into model inputs."""
...
def test_inference(
    ...
    """Run inference with the model on a given input."""
...
def main(
    ...
    """Main function for loading the model and running inference."""
    device = "cpu"
